  ...
  <section
    ...
    <div
      ...
      <div class="sm:relative sm:h-80 flex px-5 w-1/2 sm:w-full z-0">
        <ResponsiveImage
          imagePath="/images/bestBroker/heroImageDesktop.png"
          :imgAttrs="{
            role: 'presentation',
            loading: 'eager',
            fetchpriority: 'high',
      ...
      <div
        ...
        <ResponsiveImage
          imagePath="/images/bestBroker/logoBestBrokerWhite.png"
          :imgAttrs="{
            role: 'presentation',
            loading: 'eager',
            fetchpriority: 'high',
        ...
        <div class="flex flex-col gap-5">
          ...
          <p class="text-2xl text-[#D4D4D4] leading-relaxed mx-auto">
        ...
        <div class="h-full w-full lg:max-w-sm sm:mx-auto">
          <GradientBackground
            ...
            :contentClass="'flex flex-col gap-8 sm:justify-center justify-start w-fit p-5 text-center xl:text-left lg:text-left cursor-default'">
            <template #content>
              <p
