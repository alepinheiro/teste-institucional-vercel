<template>
  ...
  >
    <div
      class="bg-gradient-to-b from-[#DEDEDE] to-white absolute top-0 bottom-1/3 inset-x-20 -z-10 rounded-xl"
    ></div>
    <div
      class="px-5 lg:px-0 py-10 md:max-w-2xl lg:max-w-5xl mx-auto flex flex-col lg:flex-row items-center"
    >
      <div
        class="flex flex-col gap-2 text-center md:text-left lg:text-left xl:text-left lg:w-5/12"
      >
      ...
      <ul class="flex flex-row gap-5 py-10 lg:w-7/12">
        <li
          ...
          :key="icon"
          class="p-5 md:py-10 lg:py-10 bg-white drop-shadow-lg md:shadow-2xl lg:shadow-2xl xl::shadow-2xl rounded md:rounded-xl lg:rounded-xl xl:rounded-xl w-full flex flex-col md:gap-6 lg:gap-3 lg:h-full"
        >
