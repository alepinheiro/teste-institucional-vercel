<template>
  ...
  >
    ...
    >
      <div
        class="flex flex-col gap-2 text-center md:text-left lg:text-left xl:text-left lg:w-5/12 xl:w-5/12"
      >
      ...
      <ul class="flex flex-row gap-2 md:gap-5 lg:gap-5 xl:gap-5 py-10 md:w-full lg:w-7/12 xl:w-7/12">
        <li
