<template>
  ...
  >
    ...
    >
      ...
      <div
        class="h-64 md:flex-1 lg:flex-1 xl:flex-1 md:h-96 lg:h-96 xl:h-96 relative z-0 overflow-hidden"
      >
        <div ref="activeImage" class="h-full p-5 flex flex-col gap-2">
          <p class="text-white mt-auto text-sm">
