<template>
  <section>
    <div
      class="flex flex-col max-w-7xl lg:max-w-5xl md:max-w-2xl mx-auto w-full  justify-center"
    >
      <img
        src="/images/Home/heroBackground-sm.png"
        class="aspect-square min-md:hidden object-cover w-10/12 mr-0 ml-auto"
        alt=""
      />
      <img
        src="/images/Home/heroBackground.png"
        class="hidden xl:block absolute inset-0 w-8/12 object-contain -right-80 ml-auto -z-10"
        alt=""
      />
      <img
