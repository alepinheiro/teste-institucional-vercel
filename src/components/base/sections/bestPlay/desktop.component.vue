<template>
  <section>
    <div class="absolute -right-0 top-0 flex md:left-2/3 lg:left-[70%] xl:left-[55%] bottom-0">
      <img ref="bestPlayMockup" :src="$options.imageConfig.mockUps.youtubePhone.image"
        ...
        loading="lazy" class="w-auto h-[110vh] md:mt-48 mt-60 object-cover object-left-top" />
    </div>
