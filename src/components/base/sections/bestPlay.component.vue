  ...
  <section class="flex flex-col relative z-0 h-screen">
    <div class="overflow-hidden flex-grow flex">
      <div class="mx-auto w-64 relative md:static lg:static xl:static">
        <div
          class="absolute overflow-hidden -left-7 -right-0 -top-10 flex min-md:top-0 md:left-2/3 lg:left-[70%] xl:left-[55%] min-md:bottom-0 "
        >
          <img
            ref="bestPlayMockup"
            ...
            loading="lazy"
            class="w-auto h-[44rem] min-md:h-[54rem] xl:h-[57rem] mt-32 md:mt-24 lg:mt-48 xl:mt-24 object-cover object-left-top"
          />
        </div>
      </div>
    </div>
