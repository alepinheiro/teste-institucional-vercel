<template>
  <div class="relative" @mouseenter="showPopOver = true" @mouseleave="showPopOver = false">
    <div class="decoration"  :color="color" :linkStyle="linkStyle" id="div-1" :class="{ 'textDecoration': activeDiv === 'div1' }">Para você</div>
    <div v-if="showPopOver" class="absolute z-10 w-[18rem] p-2 bgPopUpHover rounded-lg shadowDark" >
      ...
      <router-link :to="{ name: 'BestCarFinan', params: { id: 'div1' }}" class="text-sm" >Financiamento de Veículo</router-link>
      ...
      <router-link :to="{ name: 'BestCar', params: { id: 'div1' }}" class=" text-sm" >Empréstimo com Garantia de Veículo</router-link>
