        ...
        >
          ...
          <div class="w-full p-4 rounded-b-xl mt-auto">
            ...
            <div class="w-full flex pt-8 items-center">
              ...
              <p class="text-base xl:text-lg w-full">Pague em até 420 meses</p>
            </div>
            <div class="w-full flex pt-8 items-center">
              <div class="pr-6">
                <img
      ...
      <article class="w-full mr-auto ml-auto max-w-sm p-4">
        ...
        >
          ...
          >
            ...
            <h2 class="text-base xl:text-lg defaultFont">Garantia de Imóvel</h2>
          </div>
          <div
            class="w-full p-4 rounded-b-xl justify-between flex flex-col mt-auto"
          >
            <div class="w-full flex items-center">
              <div class="pr-6">
                <img
            ...
            <div class="w-full flex pt-6 items-center">
              ...
              <p class="text-base xl:text-lg w-full">Prazos de até 240 meses</p>
            </div>
            <div class="w-full flex pt-6 items-center">
              <div class="pr-6">
                <img
        ...
        >
          ...
          >
            ...
            <div class="w-full flex pt-6 items-center">
              ...
              <p class="text-base xl:text-lg w-full">Pague em até 60 meses</p>
            </div>
            <div class="w-full flex pt-6 items-center">
              <div class="pr-6">
                <img
