<template>
  <div class="relative" @mouseenter="showPopOver = true" @mouseleave="showPopOver = false">
    <div class="decoration"  :color="color" :linkStyle="linkStyle" >Para o seu negócio</div>
    <div v-if="showPopOver" class="absolute z-10 w-[19rem] p-2 bgPopUpHover  bg-white rounded-lg shadow-lg">
      ...
      <div class="px-1 py-3 optionsHover hover:shadow-md  text-textPrimary flex flex-row items-center  w-full justify-between " @mouseover="hover4 = true" @mouseout="hover4 = false">
        <router-link :to="'/home-equity'+this.$root.utms" class="text-sm" > Home Equity  </router-link>
