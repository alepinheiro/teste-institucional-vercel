<template>
  <div class="relative" @mouseenter="showPopOver = true" @mouseleave="showPopOver = false">
    ...
    <div v-if="showPopOver" class="absolute z-10 w-60 p-2 bg-white rounded shadow-lg">
      <div class="px-2 py-3 optionsHover text-textPrimary flex flex-row items-center gap-21" @mouseover="hover = true" @mouseout="hover = false">
      ...
      <div class="px-1 py-3 optionsHover text-textPrimary flex flex-row items-center gap-28 " @mouseover="hover4 = true" @mouseout="hover4 = false">
