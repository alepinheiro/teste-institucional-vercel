<template lang="">
    ...
    <div class="mb-8 w-1/2 px-4 sm:w-full sm:px-0">
    <div class=" shadow-2xl p-6 sm:p-4  bg-primary rounded-lg flex gap-4 text-white" @mouseenter="hover = true" @mouseleave="hover = false" :class="{ 'hover': hover }">
    ...
    <div class="mb-8 w-1/2 px-4 sm:w-full sm:px-0">
    <div class=" shadow-2xl p-6 md:p-4 sm:p-4 bg-primary rounded-lg flex gap-4 text-white " id="card" @mouseenter="hover2 = true" @mouseleave="hover2 = false" :class="{ 'hover': hover2 }">
    ...
    <div class="mb-8 w-1/2 px-4 sm:w-full sm:px-0">
    <div class=" shadow-2xl p-6 sm:p-4 bg-primary rounded-lg flex gap-4  text-white md:p-4" id="card" @mouseenter="hover3 = true" @mouseleave="hover3 = false" :class="{ 'hover': hover3 }">
    ...
    <div class="mb-8 w-1/2 px-4 sm:w-full sm:px-0">
        <div class=" shadow-2xl p-6 sm:p-4 bg-primary rounded-lg flex gap-4 text-white md:p-4 " id="card" @mouseenter="hover4 = true" @mouseleave="hover4 = false" :class="{ 'hover': hover4 }">
