    ...
    <div class="md:pl-4 lg:pl-4 md:pr-4 lg:pr-4 maxWidth">
        ...
        <div class="w-6/12 mb-auto sm:w-full">
          <div class="pl-20 md:pl-4 sm:pl-4 py-4 sm:flex sm:flex-col">
            ...
            <p
              class="pt-4 text-white text-3xl sm:text-xl sm:text-center py-4 sm:pt-8 font-light
              md:text-xllg:text-2xl">
                São os juros mensais do
                <br class="sm:hidden"/>empréstimo usando
                <br class="sm:hidden"/> o veículo como garantia.
            </p>
