<template lang="">
  <div class="w-full pb-18 pt-24 md:pb-24 sm:pt-0">
    <div class="maxWidth md:w-full flex sm:h-full mr-auto ml-auto">
      <div
        class="mt-auto mb-auto w-full bg-primary shadow-xl rounded-2xl flex-wrap p-8 sm:p-2 flex justify-center"
      >
        <div class="w-full flex ml-8 sm:ml-0 py-4">
          <h1
            class="w-1/3 sm:w-2/4 text-3xl sm:text-xl mt-auto mb-0 font-bold text-primary text-center"
          >
            Por que ser Best?
          </h1>
          ...
          <div class="w-1/3 sm:w-1/4 mt-auto mb-0 text-center">
            <div class="text-white text-2xl sm:text-xl mt-auto mb-auto px-4">
              Bancos
            </div>
          </div>
        </div>
        <div class="w-full flex border-board py-3 ml-8 sm:ml-0">
          <div
            class="w-1/3 sm:w-2/4 mt-auto mb-auto text-center text-white text-xl tracking-wider sm:text-sm sm:font-normal"
          >
