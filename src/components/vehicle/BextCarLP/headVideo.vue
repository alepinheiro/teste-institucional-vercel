          ...
          <div class="w-full xl:w-5/12 lg:w-5/12 md:w-10/12 md:mr-auto md:ml-auto xl:pt-42 pt-18 sm:pt-8 ">
            <div class="py-8 sm:py-4 mt-4 w-full bg-bgLightColor p-6 sm:p-4 rounded-xl">
              <div class="rounded-xl w-full">
                ...
                <p class="py-4  pb-6">
                  Use o seu carro como garantia em troca das melhores taxas. Você consegue crédito para seus objetivos financeiros
                  <span class="font-semibold">sem precisar vender o veículo</span>com taxas a partir de
                  <span class="font-semibold">1,59% ao mês e prazos de até 60 meses.</span>
                </p>
                  ...
                  <div class="w-full ">
                    ...
                    <div class="py-3 px-8 w-full bg-primary rounded-xl text-white font-bold text-center">
                        <a :href="$options.information.appVehicleSimulator +$root.utms" style="text-decoration: none" 
                          aria-label="Clique aqui para simular seu credito" target="_blank">
                          Simular
                        </a>
