<template>
  <footer
    class="w-full flex justify-center bg-bgLight2Color xl:h-screen lg:h-screen">
    <div data-nosnippet class="mt-auto mb-auto">
      <div
        class="maxWidth flex sm:flex-wrap justify-between pt-8 sm:pt-8 md:pt-8">
        <div class="sm:w-1/2">
          ...
          <div class="md:hidden xl:hidden lg:hidden">
              ...
              <a
                ...
                <p class="flex text-sm">
                  ...
                  <svg
                    ...
                    class="w-4 h-3 mx-1 mt-1 fill-textPrimary"
                    viewBox="0 0 448 512">
            ...
            <h2 class="text-xl font-semibold text-textPrimary pt-6">
              Dúvidas?
            </h2>
          ...
          <div class="text-textPrimary pb-2">
            <a
              ...
              <p class="flex sm:justify-center">
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="w-4 h-4 mx-1 mt-1 fill-textPrimary"
                  viewBox="0 0 448 512">
                  <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                  <path
                    d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3L72 359.2l-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5 0 101.8-84.9 184.6-186.6 184.6zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7.9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z" />
      ...
      <div class="maxWidth xl:mt-20">
        <div class="w-full flex sm:flex-wrap justify-between py-2 sm:px-2">
          ...
          <div
            ...
            <a
              ...
              target="_blank">
              <svg
                class="w-8 h-8 sm:w-6 sm:h-6 mx-2 fill-textPrimary"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 576 512">
                <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                <path
        ...
        <div class="sm:px-2 sm:py-6 py-8">
          <p class="text-xs text-textPrimary">
            A <strong>Bext</strong> é uma plataforma digital que atua como
            correspondente Bancário para facilitar o processo de contratação de
            empréstimos. Como Correspondente Bancário, seguimos as diretrizes da
            Resolução nº 3.954, de 24 de fevereiro de 2011. Somos
            correspondentes bancários das seguintes instituições: BANCO BARI DE
            INVESTIMENTO E FINANCIAMENTOS S.A. 00.556.603/0001-74, BANCO
            BRADESCO S.A. 60.746.948.0001-12, BANCO DE BRASÍLIA S.A.
            00.000.208/0001-00, BANCO C6 S.A. 31.872.495/0001-72, CASHME
            SOLUÇÕES FINANCEIRAS LTDA. 34.175.529/0001-68, CREDIBLUE SOLUCOES
            FINANCEIRAS E IMOBILIARIAS LTDA. 36.750.257/0001-08, CREDITAS
            SOLUCOES FINANCEIRAS LTDA. 17.770.708/0001-24, BANCO DAYCOVAL S.A.
            62.232.889/0001-90, GALLERIA SOCIEDADE DE CREDITO DIRETO S.A.
            51.604.356/0001-75, BANCO INTER S.A. 00.416.968/0001-0, ITAU
            UNIBANCO S.A. 60.701.190/0001-04, LIBRA CRÉDITO SOLUÇÕES FINANCEIRAS
            LTDA. 34.308.576/0001-32, MONETARE SOLUÇÕES FINANCEIRAS S.A.
            32.295.379/0001-09, PONTTE SOLUCÕES FINANCEIRAS LTDA.
            33.296.599/0001-01, SANTANDER - SANB PROMOTORA DE VENDAS E COBRANCA
            S.A. 02.254.093/0001-06, SANTANDER - COMPANHIA PROMOTORA UCI
            14.010.548/0001-27, TRISUL S.A. 08.811.643/0001-27, WP2 CORRETORA DE
            SEGUROS LTDA. 40.631.755/0001-09, ALL IN CRED SOCIEDADE DE CREDITO
            DIRETO S.A. 51.414.521/0001-26.
          </p>
