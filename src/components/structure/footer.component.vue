...
<div class="w-full  flex justify-center bg-bglight2Color">
  ...
  <div class="maxWidth flex sm:flex-wrap justify-between pt-12 sm:pt-8 md:pt-8 ">
    <div class=" sm:w-1/2 ">
      ...
      <div class="sm:text-sm text-textSecondary pb-6">
        <a :href="$options.information.jobs" class="hover:text-textSecondary" style=" text-decoration: none;"
      ...
      <div class="md:hidden xl:hidden lg:hidden ">
        ...
        <div class=" text-textSecondary pb-2">
          <a :href="$options.information.socialMedia.whatsapp" class="hover:text-textSecondary" style=" text-decoration: none;"
              target="_blank">
    ...
    <div class="  ">
      ...
      <div class="sm:text-sm text-textSecondary pb-6">
        <a :href="$options.information.appClient" class="hover:text-textSecondary" style=" text-decoration: none;"
