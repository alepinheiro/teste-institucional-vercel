...
<section class="w-full  flex justify-center bg-bglight2Color">
  ...
  <div class="maxWidth flex sm:flex-wrap justify-between pt-12 sm:pt-8 md:pt-8 ">
    <div class=" sm:w-1/2 ">
      ...
      <h1 class="text-xl font-semibold text-textSecondary py-4">
        Sobre
      </h1>

      <div class="sm:text-sm text-textSecondary  pb-6">
        <router-link :to="'/sobre'+($root as IRootExtension).utms" class=" hover:text-textSecondary" aria-label="Sobre a SejaBest">
          Sobre a SejaBest
        </router-link>
      </div>
      ...
      <div class="sm:text-sm text-textSecondary pb-6">
        <a
          :href="'https://portal.seja.best/'+($root as IRootExtension).utms"
      ...
      <div class="sm:text-sm text-textSecondary pb-6">
        <router-link
        :to="'/parceiro'+($root as IRootExtension).utms"
        class=" hover:text-textSecondary"
      ...
      <div class="sm:text-sm text-textSecondary pb-6">
        <router-link to="/faq" class=" hover:text-textSecondary" aria-label="Dúvidas Frequentes">
          Dúvidas Frequentes
        </router-link>
      </div>
      ...
      <div class="md:hidden xl:hidden lg:hidden ">
        ...
        <div class="text-sm text-textSecondary pb-2">
          <router-link to="/faq" class=" hover:text-textSecondary" aria-label="Acesse nosso FAQ">
            Acesse nosso FAQ
          </router-link>
        </div>
      </div>
    ...
    <div class="  ">
      ...
      <div class="sm:text-sm text-textSecondary pb-6">
        <router-link
          :to="'/termos-de-uso'+($root as IRootExtension).utms"
      ...
      <div class="sm:text-sm text-textSecondary pb-6">
        <router-link
          :to="'/politica-de-privacidade'+($root as IRootExtension).utms"
      ...
      <div class="md:hidden xl:hidden lg:hidden ">
        ...
        <h2 class="text-sm text-textSecondary pb-2">
          contato@seja.best
        </h2>
    ...
    <div class=" sm:hidden ">
      ...
      <p class=" text-textSecondary pb-2">
        contato@seja.best
      </p>
  ...
  <div class="maxWidth mt-12">
    <div class="w-full flex sm:flex-wrap justify-between py-2 sm:px-2">
      <div class="sm:w-5/12">
        <img :src="$options.imageConfig.logoSejabestGray" alt="Logo SejaBest " title="SejaBest"  class="w-40 sm:w-11/12 h-auto  "/>
      </div>
