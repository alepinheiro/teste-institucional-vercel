...
<div class="flex mt-auto mb-auto justify-between">
  ...
  <div v-if="openProfileMenu" class="w-full text-center max-w-sm bg-white rounded-xl shadow-xl z-40 fixed p-2 top-15 right-2 ">
    ...
    <div class="bg-complementaryColor1 text-white rounded-lg px-4 py-1 font-semibold 
