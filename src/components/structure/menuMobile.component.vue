<template>
  <div class="flex mt-auto mb-auto justify-between">
    <div id="divMenu" class="cursor-pointer" @click="toggleMenu(), handleClickOutside($event)">
      <svg
        xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" :class="color"
    ...
    <div
      v-if="openProfileMenu" id="menuMobile"
      ...
      <!--Dropdown Mobile-->
      <div id="dropdown1" class="flex flex-col justify-between mb-2" :class="{ 'optionsOpen': dropdownOpen }" >
        <button
        ...
        <div class=" py-2 ml-2 px-4 shadow-lg" :class="{ hidden: !dropdownOpen }">
          <ul class="flex flex-col space-y-2 ">
            ...
            <li
              ...
              <svg
                v-show="hover1" xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 opacity-o group-hover:opacity-100 text-primary" viewBox="0 0 20 20" fill="currentColor">
                <path
                  fill-rule="evenodd"
                  d="M14.293 10.293a1 1 0 0 0 0-1.414L10.414 5.586a1 1 0 1 0-1.414 1.414L11.586 9H3a1 1 0 0 0 0 2h8.586l-3.707 3.707a1 1 0 1 0 1.414 1.414L14.293 11.7a1 1 0 0 0 0-1.414z"
            ...
            <li
              ...
              <router-link
                ...
                Veículo</router-link>
              <svg
                v-show="hover2" xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 opacity-o group-hover:opacity-100 text-primary" viewBox="0 0 20 20" fill="currentColor">
                <path
                  fill-rule="evenodd"
                  d="M14.293 10.293a1 1 0 0 0 0-1.414L10.414 5.586a1 1 0 1 0-1.414 1.414L11.586 9H3a1 1 0 0 0 0 2h8.586l-3.707 3.707a1 1 0 1 0 1.414 1.414L14.293 11.7a1 1 0 0 0 0-1.414z"
            ...
            <li
              ...
              <svg
                v-show="hover3" xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 opacity-o group-hover:opacity-100 text-primary" viewBox="0 0 20 20" fill="currentColor">
                <path
                  fill-rule="evenodd"
                  d="M14.293 10.293a1 1 0 0 0 0-1.414L10.414 5.586a1 1 0 1 0-1.414 1.414L11.586 9H3a1 1 0 0 0 0 2h8.586l-3.707 3.707a1 1 0 1 0 1.414 1.414L14.293 11.7a1 1 0 0 0 0-1.414z"
      ...
      <!--Dropdown Mobile-->
      <div id="dropdown2" class="flex flex-col mb-2" :class="[dropdown2 ? 'optionsOpen' : '']" >
        <button
