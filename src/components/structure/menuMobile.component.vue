...
<div class="flex mt-auto mb-auto justify-between"  >
  ...
  <div v-if="openProfileMenu" class="w-full border-1 max-w-sm bgPopUpHover rounded-xl shadowDark z-40 fixed p-2 top-15 right-2 " id="menuMobile">
    <div @click="openProfileMenu= !openProfileMenu" class=" cursor-pointer rounded-lg px-4 py-2 mb-2 optionsHover flex flex-row justify-between" @mouseover="hoverSVG4 = true" @mouseout="hoverSVG4=false">
      <router-link :to="'/'+this.$root.utms" class="hover:font-semibold " > Inicio </router-link>
      <svg v-show="hoverSVG4" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 opacity-o group-hover:opacity-100 " viewBox="0 0 20 20" fill="currentColor">
