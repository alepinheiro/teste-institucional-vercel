...
<div class="flex mt-auto mb-auto justify-between shadowDark">
  ...
  <div v-if="openProfileMenu" class="w-full border-1 max-w-sm bgPopUpHover rounded-xl shadowDark z-40 fixed p-2 top-15 right-2 ">
        <!--Dropdown Mobile-->
    <div class="flex flex-col justify-between" :class="{'optionsOpen': dropdownOpen}"  id="dropdown1"> 
      ...
      <div  class=" py-2 px-4 shadow-lg" :class="{hidden: !dropdownOpen}">
    ...
    <!--Dropdown Mobile-->
    <div class="flex flex-col" :class="[ dropdown2  ? 'optionsOpen': '']" id="dropdown2"> 
      <button @click="toggleDropdown2(),  removeClassDropdown2()" @mouseout="" class=" cursor-pointer flex items-center px-4 py-2 justify-between" >
        Para o seu negócio
      <svg :class="['w-4', 'h-4', 'ml-2', {'transform': dropdown2, 'rotate-180': dropdown2, 'rotate-0': dropdownOpen}]" viewBox="0 0 20 20" fill="currentColor">
        <path
          fill-rule="evenodd"
          d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
          clip-rule="evenodd"
    ...
    <div @click="openProfileMenu= !openProfileMenu" class=" cursor-pointer rounded-lg px-4 py-2 optionsHover flex flex-row justify-between" @mouseover="hoverSVG1 = true" @mouseout="hoverSVG1= false">
    ...
    <div @click="openProfileMenu= !openProfileMenu" class=" cursor-pointer rounded-lg px-4 py-2 optionsHover flex flex-row justify-between" @mouseover="hoverSVG2 = true" @mouseout="hoverSVG2 = false">
    ...
    <div @click="openProfileMenu= !openProfileMenu" class=" cursor-pointer rounded-lg px-4 py-2 optionsHover flex flex-row justify-between" @mouseover="hoverSVG3 = true" @mouseout="hoverSVG3=false">
