  ...
  <section
    ...
    <div
      ...
      <div class="flex flex-col gap-6 flex-grow">
        <ul class="flex flex-row gap-2 md:gap-5 lg:gap-5 xl:gap-5 md:w-full">
          <li
            ...
            <div
              ...
              <i
                :class="icon"
                class="group-hover:text-primary block w-full h-full transition-colors"></i>
            </div>
            <span
        ...
        <h3 class="text-textPrimary sm:text-base text-xl text-center">
