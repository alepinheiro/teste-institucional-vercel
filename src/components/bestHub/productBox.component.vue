<template>
  <section class="w-full relative z-0 flex border-t border-[#D0FE42] pt-32 sm:pt-10 pb-18 sm:pb-4">
    <div class="flex sm:flex-col md:flex-col flex-row-reverse gap-5 items-center max-w-7xl m-auto">
      <div class="z-10 flex-1 lg:flex-initial lg:relative md:-mb-24 sm:-mb-12 lg:w-2/6">
        <img 
          src="/images/bestBroker/productBox.png" class="w-auto mx-auto md:max-w-2xl object-contain lg:scale-150"
          alt="" />
      </div>

      <div class="flex flex-col gap-14 sm:gap-6 sm:px-5 md:max-w-2xl lg:w-4/6 flex-1 lg:flex-auto">
        <img src="/images/bestBroker/logoBestBrokerWhite.png" class="h-16 w-fit mx-auto object-contain" alt="" />
