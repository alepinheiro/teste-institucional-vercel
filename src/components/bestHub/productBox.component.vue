    ...
    <div
      ...
      <div
        ...
        <img
          ...
          alt="O curso definitivo para se tornar expert em Crédito Imobiliário"
          loading="lazy" />
      </div>
      ...
      <div
        ...
        <img
          ...
          class="h-16 w-fit mx-auto object-contain"
          alt="BextBroker" />
        ...
        <ul
          class="flex flex-row flex-wrap gap-3 items-center justify-center py-5">
          <li
