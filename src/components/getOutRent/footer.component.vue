<template>
  <div class="flex flex-wrap justify-around bg-bgDarkColor items-center py-24">
    <div class="flex sm:w-full  justify-center sm:pb-6">
      <img src="/images/getOutRent/logoAzul.png" class="h-12 w-auto mr-8 mt-4" />
      <img src="/images/getOutRent/bestHubAzul.png" class="h-12 w-auto " />
    </div>
    <div class="text-complementaryColor2 text-sm text-center sm:hidden md:hidden">
      <div>© {{ new Date().getFullYear() }} SejaBest Fintech de Crédito</div>
      <div><a href="www.seja.best">www.seja.best</a></div>
    </div>
    <div class=" flex sm:w-full justify-center sm:pb-6">
      <a 
        :href="$options.information.socialMedia.youtube" aria-label="Acesse nosso Youtube"
        style=" text-decoration: none;" target="_blank">
        <svg 
          class="w-8 h-8 sm:w-6 sm:h-6 mx-2 fill-complementaryColor2" xmlns="http://www.w3.org/2000/svg"
      ...
      <a 
        :href="$options.information.socialMedia.instagram" aria-label="Acesse nosso Instagram"
        style=" text-decoration: none;" target="_blank">
        <svg 
          class="w-8 h-8 sm:w-6 sm:h-6 mx-2 fill-complementaryColor2" xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 448 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
      ...
      <a :href="$options.information.socialMedia.facebook" aria-label="Acesse nosso Facebook"
        style=" text-decoration: none;" target="_blank">
        <svg class="w-8 h-8 sm:w-6 sm:h-6 mx-2 fill-complementaryColor2" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="sm:w-full md:w-full md:pt-12 text-complementaryColor2 text-sm text-center xl:hidden lg:hidden ">
      <div>© {{ new Date().getFullYear() }} SejaBest Fintech de Crédito</div>
      <div><a href="www.seja.best">www.seja.best</a></div>
    </div>
  </div>
