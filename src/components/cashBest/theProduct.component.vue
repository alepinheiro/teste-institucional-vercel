<template>
  <section class="py-20">
    ...
    >
      <div class="flex flex-col gap-6 sm:gap-3 flex-1">
        <h2 class="text-3xl text-primary font-bold sm:text-xl">
          O crédito mais barato do mercado.
        </h2>
        <p
          class="text-textPrimary w-5/6 md:w-full md:text-justify sm:w-full sm:text-sm sm:text-justify"
        >
          <b>
      ...
      <div class="flex flex-1 md:mx-auto">
        <img
      ...
      <a
        :href="`https://simulador.seja.best/?${utm.toString()}`"
        class="font-bold text-black bg-complementaryColor1 rounded px-4 py-2 w-fit hidden sm:block"
        >Simule on-line de graça</a
      >
    </div>
  </section>
