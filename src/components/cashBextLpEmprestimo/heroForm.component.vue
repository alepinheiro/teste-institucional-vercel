<template>
  <form @submit.prevent="onSubmitForm">
    <div class="flex flex-col gap-5 ">
      ...
      <div class="flex flex-col gap-2 text-center py-4 sm:py-2">
      ...
      <button
        type="submit"
        class="text-white mb-4 sm:mb-2 sm:px-6 font-bold bg-primary rounded-xl w-fit px-4 py-3 mx-auto hover:scale-105 shadow hover:shadow-black/10 hover:shadow-lg transition"
      >
        Simular de graça
      </button>
    </div>
