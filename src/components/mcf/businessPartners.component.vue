<template>
  <section>
    <div
      class="flex flex-col lg:flex-row xl:flex-row overflow-hidden rounded-2xl bg-zinc-100 w-full md:max-w-[707px] lg:max-w-5xl xl:max-w-6xl mx-auto xl:w-10/12"
    >
      <div
        class="bg-zinc-200 pt-8 pb-6 px-3 md:px-0 md:py-20 lg:py-30 lg:w-1/2 xl:w-1/2"
      >
        <div
...
export default defineComponent({
  ...
  data() {
    ...
    const bancoTCash = {
      id: 'TCash',
      image: 'bancoTCash',
      alt: 'Logo banco T-Cash',
    }

    const bancoCreditas = {
      id: 'creditas',
      image: 'bancoCreditas',
      alt: 'Logo banco Creditas',
    }

    const bancoPontte = {
      id: 'pontte',
      image: 'bancoPontte',
      alt: 'Logo banco Pontte',
    }

    const bankC6 = {
      id: 'c6ank',
      image: 'bancoC6',
      alt: 'Logo banco C6 Bank',
    }

    const smLayout = {
      firstRow: [bancoPaulista, bancoBv, bancoBRB],
      secondRow: [bancoBari, bancoRodobens, bancoInter],
      thirdRow: [bancoCashMe, bancoSantander, bancoLibra],
      fourthRow: [bancoItau, bancoDaycoval, bancoTCash],
      fifthRow: [bancoCreditas, bancoPontte, bankC6],
    }

    const mdLayout = {
      firstRow: [bancoPaulista, bancoBv, bancoBRB],
      secondRow: [bancoBari, bancoRodobens],
      thirdRow: [bancoDaycoval, bancoSantander],
      fourthRow: [bancoCashMe, bancoCreditas],
