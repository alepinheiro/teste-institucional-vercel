<template>
  <section class="relative z-0 bg-mcf-sherpaBlue">
    <div
      class="absolute bg-[url('/images/mcf/contactBackground.png')] top-0 inset-x-0 lg:inset-x-auto xl:inset-x-auto lg:bottom-0 xl:bottom-0 h-[42%] md:h-[44%] lg:h-auto xl:h-auto lg:left-[41%] xl:left-[41%] lg:right-0 xl:right-0 bg-cover bg-center -z-10"
    ></div>
    <div
    ...
    >
      ...
      >
        ...
        <p>
          Uma grande parceria que reforça a oferta de serviços financeiros da
          Minha Casa Financiada, proporcionando aos clientes soluções
          abrangentes para suas necessidades imobiliárias.
          <b>
