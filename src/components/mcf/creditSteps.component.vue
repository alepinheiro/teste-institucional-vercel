<template>
  <section class="flex flex-col gap-10 ">
    <h2 class="text-3xl md:text-4xl lg:text-4xl text-mcf-freeSpeechAquamarine text-center md:max-w-[707px] lg:max-w-5xl lg:w-5/6 mx-auto">
      São apenas
    ...
    <ul class="flex flex-col md:flex-row lg:flex-row xl:flex-row md:flex-wrap lg:flex-wrap gap-5 md:max-w-[707px] lg:max-w-5xl lg:w-5/6 xl:max-w-[1068px] md:mx-auto lg:mx-auto xl:mx-auto">
      ...
      >
        ...
        <p class="text-warren-grey" v-html="description"></p>
      </li>
    </ul>
  </section>
</template>
    ...
    const steps = [
      {
        ...
        title: 'Simulação',
        description:
          '<b>Simule nas mais de 20 instituições parcerias</b> e obtenha resultados em tempo real.',
      },
      {
        id: 2,
        title: 'Aprovação',
      ...
      },
      {
        ...
        title: 'Assinatura',
        description:
          'Aqui é feito o envio dos documentos, <b>assinaturas dos contratos</b> e trâmites.',
      },
      {
        id: 4,
        title: 'Liberação',
        description:
          'Com tudo aprovado, o crédito é liberado e depositado na conta do cliente.',
      },
    ]
    return {
      steps,
