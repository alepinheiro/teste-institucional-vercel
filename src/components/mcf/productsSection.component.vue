    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <h3
              class="text-2xl md:text-3xl font-bold text-mcf-nightRider md:w-3/4"
            >
              {{ title }}
            </h3>
            ...
            <div class="flex flex-col gap-8">
              ...
              >
                <component :is="option.icon" class="w-14 h-14 object-contain text-mcf-freeSpeechAquamarine"></component>
        ...
        <div class="w-5/6 flex flex-row justify-between mx-auto">
          ...
          >
            <svg
              width="20"
              height="20"
              class="fill-warren-stormGray hover:fill-mcf-freeSpeechAquamarine transition-all"
            >
              <path
          ...
          >
            <svg
              width="20"
              height="20"
              class="fill-warren-stormGray hover:fill-mcf-freeSpeechAquamarine transition-all rotate-180"
            >
              <path
                d="m9.12 7.259-1.837 1.99H15v1.5H7.282l1.839 1.992-1.103 1.018-2.687-2.911a1.25 1.25 0 0 1 0-1.696l2.687-2.91 1.103 1.017Z"
              />
    ...
    const slides = [
      ...
      },
      {
        ...
        options: [
          ...
          {
            id: 3,
            icon: markRaw(BuildingColumnIcon),
