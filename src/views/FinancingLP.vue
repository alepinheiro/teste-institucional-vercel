    ...
    <div class="text-textPrimary ">
      ...
      <div class="maxWidth sm:hidden flex md:mt-12">
        <div class="w-6/12 sm:w-[0.3] mt-auto mb-auto py-16">
          <img
            :src="$options.imageConfig.finanBest.photoKeys" alt="Financiamento Imobiliário"
          ...
          <div class="pt-6 sm:pt-4 text-right pb-12">
            <button class="buttonComplementaryColor1">
              <a
                ...
                :href="$options.information.appRealEstateSimulator + ($root as IRootExtension).utms" style=" text-decoration: none;"
                target="_blank">
                Faça uma simulação
              </a>
            </button>
      ...
      <div class="maxWidth md:w-full flex sm:h-full mr-auto ml-auto sm:ml-0S">
        <div
          ...
          <div class="w-full flex py-4 ">
            <div class="w-1/3 sm:w-2/4 mt-auto mb-0 text-3xl sm:text-base ml-8 text-primary text-center  font-bold">Por
              que ser Best?</div>
