<template>
  <div class="w-full">
    ...
    <section
      class="bg-bgLightColor xl:pt-36 xl:pb-48 lg:pt-24 md:pt-14 sm:pt-12 pb-18 sm:pb-0 md:pb-12">
      <h1
    ...
    <div class="bg-bgDarkColor">
      ...
      <section class="bg-bgLightColor pt-12 xl:pt-18 lg:pt-18">
        <Testimonials
          title="Quem sonhou, se organizou e investiu com a ajuda da Bext" />
