    ...
    <div class="bg-bglightColor">
      ...
      <section class="maxWidth py-12">
        <div class="text-textPrimary">
          <h2 class="text-primary font-semibold pt-4 pb-2">1. Termos</h2>
          <p class="pl-3 pb-3">
            Ao acessar ao site SejaBest Fintech de Crédito Imobiliário, concorda
          ...
          <p class="pl-3 pb-3">
            ...
            materiais (informações ou software) no site SejaBest Fintech de
            Crédito Imobiliário , apenas para visualização transitória pessoal e
          ...
          <ul class="pl-6 pb-3">
            ...
            <li>
              ...
              software contido no site SejaBest Fintech de Crédito Imobiliário;
            </li>
            <li>
            ...
            <li>
              5. ou transferir os materiais para outra pessoa ou 'espalhe' os
          ...
          <p class="pl-3 pb-3">
            ...
            dessas restrições e poderá ser rescindida por SejaBest Fintech de
            Crédito Imobiliário a qualquer momento. Ao encerrar a visualização
          ...
          <p class="pl-3 pb-3">
            1. Os materiais no site da SejaBest Fintech de Crédito Imobiliário
            são fornecidos 'como estão'. SejaBest Fintech de Crédito Imobiliário
          ...
          <p class="pl-3 pb-3">
            2. Além disso, a SejaBest Fintech de Crédito Imobiliário não garante
            ...
            outra forma relacionado a esses materiais ou em sites vinculados a
            este site.
          </p>

          <h2 class="text-primary font-semibold pt-4 pb-2">4. Limitações</h2>
          <p class="pl-3 pb-3">
            Em nenhum caso a SejaBest Fintech de Crédito Imobiliário ou seus
            ...
            materiais em SejaBest Fintech de Crédito Imobiliário, mesmo que
            SejaBest Fintech de Crédito Imobiliário ou um representante
            autorizado da SejaBest Fintech de Crédito Imobiliário tenha sido
          ...
          <p class="pl-3 pb-3">
            Os materiais exibidos no site da SejaBest Fintech de Crédito
            Imobiliário podem incluir erros técnicos, tipográficos ou
            fotográficos. SejaBest Fintech de Crédito Imobiliário não garante
            que qualquer material em seu site seja preciso, completo ou atual.
            SejaBest Fintech de Crédito Imobiliário pode fazer alterações nos
            materiais contidos em seu site a qualquer momento, sem aviso prévio.
            No entanto, SejaBest Fintech de Crédito Imobiliário não se
            compromete a atualizar os materiais.
          </p>

          <h2 class="text-primary font-semibold pt-4 pb-2">6. Links</h2>
          <p class="pl-3 pb-3">
            A SejaBest Fintech de Crédito Imobiliário não analisou todos os
            ...
            endosso por SejaBest Fintech de Crédito Imobiliário do site. O uso
            de qualquer site vinculado é por conta e risco do usuário.
          </p>

          <h2 class="text-primary font-semibold pt-4 pb-2">7. Modificações</h2>
          <p class="pl-3 pb-3">
            A SejaBest Fintech de Crédito Imobiliário pode revisar estes termos
            de serviço do site a qualquer momento, sem aviso prévio. Ao usar
            este site, você concorda em ficar vinculado à versão atual desses
            termos de serviço.
          </p>

          <h2 class="text-primary font-semibold pt-4 pb-2">8. Lei aplicável</h2>
          <p class="pl-3 pb-3">
            Estes termos e condições são regidos e interpretados de acordo com
            as leis da SejaBest Fintech de Crédito Imobiliário e você se submete
