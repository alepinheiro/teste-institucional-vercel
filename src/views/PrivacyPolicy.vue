    ...
    <div class="maxWidth py-12" >
      ...
      <div class="text-textPrimary ">
        ...
        <div>
          ...
          Ao fazê-lo, agimos na qualidade de controlador desses dados e estamos sujeitos às disposições da 
          Lei Federal n. 13.709/2018 (Lei Geral de Proteção de Dados Pessoais – LGPD).
        </div>
        <div>Nós cuidamos da proteção de seus dados pessoais e, por isso, disponibilizamos 
          esta política de privacidade, que contém informações importantes sobre:</div>
        <div class="pl-3 pb-3">- Quem deve utilizar nosso site;  </div>
        <div class="pl-3 pb-3">- Quais dados coletamos e o que fazemos com eles;  </div>
        ...
        <ul class="pl-9 pb-3">
            ...
            <li>- Profissão  </li>  
            <li>- Endereço  </li>  
            <li>- Valor de imóvel próprio </li>   
            <li>- CNPJ  </li>  
            <li>- Faturamento Estimado</li>  
        </ul>
        <div class="pl-6 pb-3">A coleta destes dados ocorre nos seguintes momentos:</div>
        ...
        <div class="pl-6 pb-3">Os cookies não permitem que qualquer arquivo ou informação sejam extraídos do disco rígido do 
        usuário, não sendo possível, ainda, que, por meio deles, se tenha acesso a informações pessoais que não tenham 
        partido do usuário ou da forma como utiliza os recursos do site.</div>
        <div class="pl-6 pb-3">a. Cookies do site</div>
        <div class="pl-9 pb-3">Os cookies do site são aqueles enviados ao computador ou dispositivo do usuário e administrador 
        exclusivamente pelo site.</div>
        <div class="pl-9 pb-3">As informações coletadas por meio destes cookies são utilizadas para melhorar e personalizar 
        a experiência do usuário, sendo que alguns cookies podem, por exemplo, ser utilizados para lembrar as preferências 
        e escolhas do usuário, bem como para o oferecimento de conteúdo personalizado.</div>
        <div class="pl-6 pb-3">b. Cookies de terceiros</div>
        <div class="pl-9 pb-3">Alguns de nossos parceiros podem configurar cookies nos dispositivos dos usuários que acessam nosso site.</div>
        <div class="pl-9 pb-3">Estes cookies, em geral, visam possibilitar que nossos parceiros possam oferecer seu conteúdo e seus serviços ao usuário 
        que acessa nosso site de forma personalizada, por meio da obtenção de dados de navegação extraídos a partir de sua interação com o site.</div>
        <div class="pl-9 pb-3">O usuário poderá obter mais informações sobre os cookies de terceiro e sobre a forma como os dados 
        obtidos a partir dele são tratados, além de ter acesso à descrição dos cookies utilizados e de suas características, 
        acessando o seguinte link:</div>
        <div class="pl-9 pb-3"><a class="" href="https://policies.google.com/technologies/ads?hl=pt-BR">Google Ads: <br/>  https://policies.google.com/technologies/ads?hl=pt-BR  </a></div>
        <div class="pl-9 pb-3"><a href="https://support.google.com/analytics/answer/6004245?hl=pt-BR ">Google Analytics: <br/> https://support.google.com/analytics/answer/6004245?hl=pt-BR   </a></div>
        <div class="pl-9 pb-3"><a href="https://www.facebook.com/legal/technology_terms">Facebook: <br/> https://www.facebook.com/legal/technology_terms   </a></div>
        <div class="pl-9 pb-3"><a href="https://legal.hubspot.com/cookie-policy">Hubspot:<br/>  https://legal.hubspot.com/cookie-policy   </a></div>
        <div class="pl-9 pb-3"><a href="https://about.ads.microsoft.com/en-gb/resources/policies/microsoft-advertising-privacy-policy">Microsoft Ads: <br/>  https://about.ads.microsoft.com/en-gb/resources/policies/microsoft-advertising-privacy-policy  </a></div>
        <div class="pl-9 pb-3"><a href="https://www.hotjar.com/legal/policies/privacy/">Hotjar: <br/> https://www.hotjar.com/legal/policies/privacy/ </a></div>

        <div class="pl-9 pb-3">As entidades encarregadas da coleta dos cookies poderão ceder as informações obtidas a terceiros.</div>
        <div class="pl-6 pb-3">c. Gestão de cookies</div>
        <div class="pl-9 pb-3">O usuário poderá se opor ao registro de cookies pelo site, bastando que desative esta opção no seu 
        próprio navegador. Mais informações sobre como fazer isso em alguns dos principais navegadores utilizados hoje podem 
        ser acessadas a partir dos seguintes links:</div>
        <div class="pl-9 pb-3">
          <a href="https://support.microsoft.com/pt-br/help/17442/windows-internet-explorer-delete-manage-cookies">Internet Explorer: <br/> 
          https://support.microsoft.com/pt-br/help/17442/windows-internet-explorer-delete-manage-cookies </a>
        </div>
        <div class="pl-9 pb-3">
          <a href="https://support.apple.com/pt-br/guide/safari/sfri11471/mac">Safari:  <br/>
            https://support.apple.com/pt-br/guide/safari/sfri11471/mac </a>
        </div>
        <div class="pl-9 pb-3">
          <a href="https://support.google.com/chrome/answer/95647?hl=pt-BR&hlrm=pt">Google Chrome:  <br/>
            https://support.google.com/chrome/answer/95647?hl=pt-BR&hlrm=pt </a>
        </div>
        <div class="pl-9 pb-3">
          <a href="https://support.mozilla.org/pt-BR/kb/ative-e-desative-os-cookies-que-os-sites-usam">Mozila Firefox:  <br/>
            https://support.mozilla.org/pt-BR/kb/ative-e-desative-os-cookies-que-os-sites-usam </a>
        </div>
        <div class="pl-9 pb-3">
        ...
        <div class="pl-3 pb-3">Alguns dados são compartilhados com os parceiros financeiros da BEST, tais como 
         (Bancos, Fintechs, Financeiras, companhias hipotecárias e fundos de investimentos), que são:</div>
        <ul class="pl-6 pb-3">
            <li>- BANCO DAYCOVAL S.A CNPJ sob o no 62.232.889/0001-90</li>  
            <li>- BANCO SANTANDER S.A. CNPJ sob o no 90.400.888/0001-42 </li>  
            <li>- CASHME SOLUÇÕES FINANCEIRAS LTDA CNPJ sob o no 34.175.529/0001-68.</li>    
            <li>- ITAU UNIBANCO S.A. CNPJ sob o no 60.701.190/0001-04 </li>  
            <li>- COMPANHIA PROMOTORA UCI CNPJ sob o no 14.010.548/0001-27 </li>  
            <li>- PONTTE Soluções Financeiras LTDA CNPJ sob o no 33.296.599/0001-01 </li>  
            <li>- BANCO BARI de Investimentos e Financiamentos SA. CNPJ  sob o no 00.556.603/0001-74 </li>   
            <li>- COMPANHIA HIPOTECARIA PIRATINI – CHP. CNPJ sob o no 18.282.093/0001-50  </li>  
            <li>- B.V. FINANCEIRA S.A  CNPJ sob o no 01.149.953/0001-89</li>  
        </ul>
        <div class="pl-3 pb-3">Estes dados são compartilhados pelas seguintes razões e para as seguintes finalidades:</div>
        <ul class="pl-6 pb-3">
          <li>- Receber contato por telefone, e-mail, SMS, WhatsApp, ou outros meios de comunicação para confirmação das informações prestadas.  </li>  
          <li>- Consultas sobre suas informações na base de dados do Sistema de Informações de Crédito (SCR), mediante a obtenção do seu consentimento com esse uso  </li>  
          <li>- Investigações e medidas de prevenção e combate a ilícitos, fraudes, crimes financeiros e garantia da segurança dos clientes e do sistema financeiro.  </li>    
          <li>- ICumprimento de obrigação legal ou regulatória </li>  
        </ul>
        ...
        <div class="pl-3 pb-3">1. Legítimo interesse</div>
        <div class="pl-6 pb-3">Para determinadas operações de tratamento de dados pessoais, nos baseamos exclusivamente em nosso 
          interesse legítimo. Para saber mais sobre em quais casos, especificamente, nos valemos desta base legal, ou para obter 
          mais informações sobre os testes que fazemos para termos certeza de que podemos utilizá-la, entre em contato com nosso 
        ...
        <div class="pl-3 pb-3">É importante destacar que, nos termos da LGPD, não existe um direito de eliminação de dados 
          tratados com fundamento em bases legais distintas do consentimento, a menos que os dados seja desnecessários, excessivos 
          ou tratados em desconformidade com o previsto na lei.</div>
        <div class="pl-3 pb-3">1. Como o titular pode exercer seus direitos</div>
        <div class="pl-6 pb-3">Para garantir que o usuário que pretende exercer seus direitos é, de fato, o titular dos dados
          pessoais objeto da requisição, poderemos solicitar documentos ou outras informações que possam auxiliar em sua correta 
        ...
        <div class="pl-3 pb-3">As medidas que utilizamos levam em consideração a natureza dos dados, o contexto e a 
          finalidade do tratamento, os riscos que uma eventual violação geraria para os direitos e liberdades do usuário,
           e os padrões atualmente empregados no mercado por empresas semelhantes à nossa.</div>
        <div class="pl-3 pb-3">Entre as medidas de segurança adotadas por nós, destacamos as seguintes:</div>
        <ul class="pl-6 pb-3">
        ...
        <div class="pl-3 pb-3">Ainda que adote tudo o que está ao seu alcance para evitar incidentes de segurança, é 
          possível que ocorra algum problema motivado exclusivamente por um terceiro – como em caso de ataques de hackers 
          ou crackers ou, ainda, em caso de culpa exclusiva do usuário, que ocorre, por exemplo, quando ele mesmo transfere 
          seus dados a terceiro. Assim, embora sejamos, em geral, responsáveis pelos dados pessoais que tratamos, nos eximimos 
          de responsabilidade caso ocorra uma situação excepcional como essas, sobre as quais não temos nenhum tipo de controle.</div>
        <div class="pl-3 pb-3">De qualquer forma, caso ocorra qualquer tipo de incidente de segurança que possa gerar risco ou dano 
        ...
        <div class="pl-3 pb-3">Endereço postal:Rua Miguel Matte, 687, sala 801, Ed. Evolution – CEP 88331-085, Pioneiros, Balneário Camboriú – SC</div>
      </div>
    </div>
