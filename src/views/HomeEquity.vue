  ...
  <div class="w-full bg-bglight2Color overflow-x-hidden overflow-y-hidden">
    <div class="text-textPrimary gradienteSBLight">
      <div class="bgCashBest sm:hidden md:hidden">
        <div class="maxWidth xl:h-screen lg:h-screen">
          ...
          <div class="w-full flex xl:mt-24 lg:mt-24 md:mt-4 sm:mt-4">
            <div class="md:pt-4 sm:py-8 max-w-[600px] w-full">
              <div class="bg-primary rounded-xl w-full shadow-2xl px-12 py-8">
                ...
                <div class="pt-0 text-white pb-6">
                  As menores taxas do mercado, a partir de <span class="font-semibold">0,88% a.m + IPCA ou fixa 1,49% a.m.</span> Pegando até <span class="font-semibold">60% do valor</span> do seu imóvel como capital para usar como quiser,
                  você tem até 240 meses para pagar.
                ...
                <div class="flex w-full items-center border-b-1 border-complementaryColor3 pb-4">
                  ...
                  <div class="w-10/12 text-lg text-white">
                    Sem <span class="text-complementaryColor3">Filas.</span> Sem <span class="text-complementaryColor3">gerentes.</span> Sem <span class="text-complementaryColor3">complexidade</span>
                  </div>
                </div>
                ...
                <div class="w-full flex items-end justify-between">
                  ...
                  <div class="w-3/12">
                    <div class="p-2 w-full bg-complementaryColor1 rounded-xl text-white text-center">
                      <a :href="$options.information.appRealEstateSimulator+this.$root.utms" style="text-decoration: none;" target="_blank">Simular</a>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <div @click="showVideo=true" class="h-[500px] p-16 w-[600px] md:w-7/12 text-white md:pr-4 sm:hidden"></div>
          </div>
        </div>
      </div>
              ...
              <div class="rounded-xl w-full">
                ...
                <div class="bg-bglight2Color p-4 rounded-xl">
                  <div class="flex w-full items-center border-b-1 border-primary pb-4">
                    ...
                    <div class="w-10/12 text-lg">Sem <span class="text-primary">Filas.</span> Sem <span class="text-primary">gerentes.</span> Sem <span class="text-primary">complexidade</span></div>
                  </div>
      ...
      <div class="md:hidden xl:hidden lg:hidden maxWidth">
        <div class="text-6xl lg:text-5xl text-center pb-8 sm:text-5xl md:text-6xl titleFontBold text-white">
          E o que é <br />
          Home<span class="textDecoration"> Equity?</span>
        </div>
        <div class="text-white text-sm text-center pb-6">
          É o Crédito com Garantia de Imóvel, também conhecido como Empréstimo, ideal para quem quer as menores taxas de juros do mercado e um longo prazo para pagamento. Nessa modalidade, você utiliza sua casa, apartamento ou sala
          comercial como garantia de crédito e desfruta das melhores condições disponíveis no mercado.
        </div>
        <div class="border-1 rounded-xl w-full text-white mr-4">
          ...
          <div class="w-full p-6 bg-secondary rounded-b-xl">
            ...
            <div class="buttonComplementaryColor1 mt-6 text-center">
              <a :href="$options.information.appRealEstateSimulator+this.$root.utms" style="text-decoration: none;" target="_blank">Faça uma simulação</a>
            </div>
          </div>
        </div>
      </div>
      <div class="maxWidth sm:hidden flex mt-12">
        <div class="w-6/12 sm:w-4/12 mt-auto mb-auto pt-8">
          <img :src="$options.imageConfig.cashBest.photoMan" alt="Home Equity" class="w-full h-auto xl:absolute lg:absolute xl:w-116 lg:w-[28rem] xl:bottom-[-34rem] lg:bottom-[-31rem] mb-0rem" />
        </div>
        <div class="w-6/12 sm:w-8/12 mt-auto mb-auto xl:mt-3 lg:mt-3">
          ...
          <div class="text-white text-xl sm:text-xs md:text-sm text-right w-11/12 mr-0 ml-auto mt-12 sm:mt-6">
            É o Crédito com Garantia de Imóvel, também conhecido como Home Equity, ideal para quem quer as menores taxas de juros do mercado e um longo prazo para pagamento. Nessa modalidade, você utiliza sua casa, apartamento ou sala
            comercial como garantia de crédito e desfruta das melhores condições disponíveis no mercado.
          </div>
          <div class="pt-6 sm:pt-4 text-right">
            <button class="buttonComplementaryColor1"><a class="sm:text-sm text-2xl" :href="$options.information.appRealEstateSimulator+this.$root.utms" style="text-decoration: none;" target="_blank">Faça uma simulação</a></button>
          </div>
        </div>
      </div>
      <div class="maxWidth flex py-24 sm:py-12">
        ...
        <div class="w-3/4 sm:w-1/2 mt-auto mb-auto">
          <div class="bg-bglightColor sm:hidden md:hidden rounded-2xl">
            <Splide
              :options=" {type:'loop', perPage: 2, perMove: 1, padding: '6rem', drag   : 'free',
            ...
            >
              <SplideSlide v-for="slide in $options.imageConfig.cashBest.sliderPhones">
                <div class="rounded-2xl">
                  <img :src="slide.img" class="px-4 rounded-2xl" :alt="slide.alt" />
                </div>
              </SplideSlide>
            </Splide>
          </div>
          <div class="bg-bglightColor xl:hidden lg:hidden sm:hidden rounded-2xl">
            <Splide
              :options=" {type:'loop', perPage: 2, perMove: 1,  drag   : 'free',
            } "
              aria-label="Vantagens para você"
            >
              <SplideSlide v-for="slide in $options.imageConfig.cashBest.sliderPhones">
          ...
          <div class="bg-bglightColor xl:hidden lg:hidden md:hidden rounded-2xl">
            <Splide
              :options=" {type:'loop', perPage: 1, perMove: 1,  drag   : 'free',
            } "
              aria-label="Vantagens para você"
            >
              <SplideSlide v-for="slide in $options.imageConfig.cashBest.sliderPhones">
      ...
      <div class="maxWidth flex pt-32 sm:pt-8 pb-56 md:pb-4 sm:pb-4">
        <div class="w-3/4 md:w-2/3 sm:w-1/2 flex mt-auto mb-auto">
          <div class="w-full xl:hidden lg:hidden md:hidden rounded-2xl">
            <Splide
              :options=" {type:'loop', perPage: 1, perMove: 1,  drag   : 'free',height   : '23.5rem',
             rewind : true, pagination:false, direction: 'ttb',} "
              aria-label="Você pode obter o recurso para:"
            >
              <SplideSlide v-for="slide in $options.imageConfig.cashBest.sliderMoney1">
                <div class="pt-[2.5rem]">
          ...
          <div class="w-full xl:hidden lg:hidden sm:hidden rounded-2xl">
            <Splide
              :options=" {type:'loop', perPage: 1, perMove: 1,  drag   : 'free',height   : '26.5rem',
             rewind : true, pagination:false, direction: 'ttb',} "
              aria-label="Você pode obter o recurso para:"
            >
              <SplideSlide v-for="slide in $options.imageConfig.cashBest.sliderMoney1">
          ...
          <div class="w-full xl:hidden lg:hidden sm:hidden rounded-2xl mt-10">
            <Splide
              :options=" {type:'loop', perPage: 1, perMove: 1,  drag   : 'free',height   : '26.5rem',
             rewind : true, pagination:false, direction: 'ttb',} "
              aria-label="Você pode obter o recurso para:"
            >
              <SplideSlide v-for="slide in $options.imageConfig.cashBest.sliderMoney2">
                <div class="pt-[2.5rem]">
                  <img :src="slide.img" class="px-4 w-[20rem]" :alt="slide.alt" />
                </div>
              </SplideSlide>
          ...
          <div class="w-1/3 sm:hidden md:hidden rounded-2xl">
            <Splide
              :options=" {type:'loop', perPage: 1, perMove: 1,  drag   : 'free',height   : '32.5rem',
             rewind : true, pagination:false, direction: 'ttb',} "
              aria-label="Você pode obter o recurso para:"
            >
              <SplideSlide v-for="slide in $options.imageConfig.cashBest.sliderMoney1">
          ...
          <div class="w-1/3 sm:hidden md:hidden rounded-2xl mt-16">
            <Splide
              :options=" {type:'loop', perPage: 1, perMove: 1,  drag   : 'free',height   : '32.5rem',
             rewind : true, pagination:false, direction: 'ttb',} "
              aria-label="Você pode obter o recurso para:"
          ...
          <div class="w-1/3 sm:hidden md:hidden rounded-2xl">
            <Splide
             ...
             rewind : true, pagination:false, direction: 'ttb',} "
              aria-label="Você pode obter o recurso para:"
            >
              <SplideSlide v-for="slide in $options.imageConfig.cashBest.sliderMoney3">
                <div class="pt-[2.5rem]">
                  <img :src="slide.img" class="px-4 w-[20rem]" :alt="slide.alt" />
                </div>
              </SplideSlide>
        ...
        <div class="w-1/4 md:w-1/3 sm:w-1/2 text-right text-white mt-auto mb-auto pr-4">
          <div class="text-4xl md:text-2xl sm:text-2xl titleFontBold">
            Faça o que você quiser com <br />
            <span class="text-complementaryColor3">seu dinheiro</span>
          </div>
    ...
    <div class="w-full xl:mt-[-10rem] sm:mt-[-8rem] flex justify-center sm:hidden md:hidden">
      <div class="ml-auto mr-auto maxWidth">
        <Splide
          :options=" {type:'loop', perPage: 1, perMove: 1,  drag   : 'free' ,  height   : '25rem',trimSpace: 'move', 
        rewind : true, pagination:true, arrows:true}"
          aria-label="Você pode obter o recurso para:"
          class="blueSplide"
        >
    ...
    <div class="maxWidth xl:hidden lg:hidden">
      ...
      <div class="bg-bglight2Color shadow-xl border-1 rounded-xl p-4">
        <div class="flex w-full">
          ...
          <div class="text-primary text-2xl titleFontBold pr-2"><span class="text-complementaryColor1">#1</span> Simule e solicite.</div>
        </div>
        <div class="p-4" v-if="tutorial.show1">
          A simulação é feita através do nosso <a :href="$options.information.appRealEstateSimulator+this.$root.utms" class="text-primary" style="text-decoration: none;" target="_blank">simulador.</a> Em até minutos você tem o resultado,
      ...
      <div class="bg-bglight2Color mt-4 shadow-xl border-1 rounded-xl p-4">
        <div class="flex w-full">
          ...
          <div class="text-primary text-2xl titleFontBold pr-2"><span class="text-complementaryColor1">#2</span> Envie seus documentos</div>
        </div>
        <div class="p-4" v-if="tutorial.show2">
          Para uma análise de crédito mais detalhada, envie os documentos solicitados. Após o envio, seus documentos serão analisados e será enviada uma proposta concreta.
        </div>
      </div>
      <div class="bg-bglight2Color mt-4 shadow-xl border-1 rounded-xl p-4">
        <div class="flex w-full">
          ...
          <div class="text-primary text-2xl titleFontBold pr-2"><span class="text-complementaryColor1">#3</span> Avaliação do Imóvel</div>
        </div>
      ...
      <div class="bg-bglight2Color mt-4 shadow-xl border-1 rounded-xl p-4">
        <div class="flex w-full">
          ...
          <div class="text-primary text-2xl titleFontBold pr-2"><span class="text-complementaryColor1">#4</span> Liberação do recurso</div>
        </div>
        <div class="p-4" v-if="tutorial.show4">
          Depois de passar por todas as etapas e a documentação estiver concluída, seu recurso será liberado! Aqui encerramos a operaçãocom êxito, sempre entregando a melhor experiência ao cliente!
        </div>
      </div>
    </div>
    <div class="w-full py-12">
      <div class="maxWidth md:w-full flex sm:h-full mr-auto ml-auto">
        <div class="mt-auto mb-auto w-full bg-bglight2Color shadow-xl border-1 rounded-2xl flex-wrap flex justify-center p-6 sm:p-2">
          <div class="w-10/12 sm:w-11/12">
            <div class="w-full flex ml-8 sm:ml-0 py-4">
              <div class="w-1/3 sm:w-2/4 mt-auto mb-0 text-2xl sm:text-xl sm:leading-5 text-primary text-center font-bold">Por que ser Best?</div>
    ...
    <rodape />
    <popUpVideo v-if="showVideo" :videoUrl="videoUrl" :videoStyle="videoStyle" @closePopUp="showVideo=false" />
  </div>
</template>
<script lang="ts">
