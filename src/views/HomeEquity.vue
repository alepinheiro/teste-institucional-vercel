    ...
    <div class="text-textPrimary gradienteSBLight">
      <div class="bgCashBest sm:hidden md:hidden">
        <div class="maxWidth xl:h-screen lg:h-screen">
          ...
          <section class="w-full flex mt-6 xl:mt-28 lg:mt-24 md:mt-4 sm:mt-4 mt-0rem">
              ...
              <div class=" rounded-xl w-full ">
                ...
                <p class=" py-4 text-white pb-6">
                  As menores taxas do mercado, a partir de <span class="font-semibold">0,88% a.m + IPCA ou fixa 1,49%
                    a.m.</span>
                  Pegando até <span class="font-semibold">60% do valor</span> do seu imóvel como capital para usar como
                  quiser, você tem até 240 meses para pagar.
        ...
        <div class="border-1  rounded-xl w-full text-white mr-4">
          ...
          <div class="w-full p-6 bg-secondary rounded-b-xl">
            ...
            <div class="w-full flex  items-center">
              <div class="pr-6 ">
                <img :src="$options.imageConfig.icons.percentageFill" alt="Icone %" class="w-9 h-8  " />
              </div>
            ...
            <div class="w-full flex pt-6 items-center">
              <div class="pr-6 ">
                <img :src="$options.imageConfig.icons.calendarFill" alt="Ícone calendário" class="w-9 h-8  " />
              </div>
              <h3 class="text-xl w-full">
            ...
            <div class="w-full flex pt-6 items-center">
              <div class="pr-6 ">
                <img :src="$options.imageConfig.icons.moneyFill" alt="ícone $" class="w-9 h-8  " />
              </div>
              <h3 class="text-xl w-full">
      ...
      <section class="maxWidth sm:hidden flex md:mt-12 mb-26">
        ...
        <div class="w-6/12 sm:w-4/12 mt-auto mb-auto">
          <img
            ...
            title="Home Equity"
            class="w-full h-auto xl:absolute lg:absolute xl:w-116 lg:w-[28rem] xl:bottom-[-34rem]
            lg:bottom-[-31rem] mb-0rem" />
        </div>
      ...
      <section class="maxWidth flex py-24 sm:py-12">
        ...
        <div class="w-3/4 sm:w-1/2 mt-auto mb-auto">
          ...
          <div id="sliderPhone" class="bg-bglightColor sm:hidden md:hidden rounded-2xl " >
            <Splide
              :options="{
                type: 'loop',
                perPage: 2,
    ...
    <section class="w-full py-12 lg:pb-16 md:pb-30 md:pt-12 sm:pb-26">
      <div class="maxWidth md:w-full flex sm:h-full mr-auto ml-auto">
        <div
          ...
          flex-wrap flex justify-center p-6 sm:p-2">
