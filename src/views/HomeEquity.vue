<template>
  <div class="w-full bg-bglight2Color overflow-x-hidden overflow-y-hidden">
    <div class="text-textPrimary gradienteSBLight">
      <div class="bgCashBest sm:hidden md:hidden">
        <div class="maxWidth xl:h-screen lg:h-screen">
          ...
          <section
            class="w-full flex mt-6 xl:mt-28 lg:mt-24 md:mt-4 sm:mt-4 mt-0rem"
          >
            <div class="md:pt-4 sm:py-8 max-w-[600px] w-full">
              <div class="bg-primary rounded-xl w-full shadow-2xl p-12">
                <div class="text-6xl titleFontBold text-white pb-6">
                  <h1>
                    Conheça o
                    <span class="textDecoration text-complementaryColor3"
                      >CashBest,</span
                    >
                ...
                <h2
                  class="w-10/12 text-xl text-white pt-2 font-semibold text-textPrimary"
                >
                ...
                <div class="w-full flex items-end justify-between">
                  ...
                  <div class="w-3/12">
                    ...
                    >
                      <a
                        :href="
                          $options.information.appRealEstateSimulator +
      ...
      <div class="xl:hidden lg:hidden md:hidden">
        <div class="maxWidth">
          ...
          <section class="w-full">
            <div class="w-full mt-4" @click="showVideo = true">
              <img
                :src="$options.imageConfig.cashBest.phoneVideo"
                alt="Video Crédito com Garantia de Imóvel"
                class="w-full h-auto"
              />
            </div>
            <div class="py-8 sm:py-4 w-full">
              <div class="rounded-xl w-full">
                ...
                <p class="py-4 text-white pb-6">
                  ...
                  <span class="text-complementaryColor3">
                    Assista acima e saiba como.</span
                  >
                </p>
        ...
        <div class="maxWidth">
          ...
          <section class="w-full flex">
            <div class="w-1/2 pt-4 mt-auto mb-auto">
              <div>
                <h1 class="text-5xl titleFontBold text-white pb-6">
                  Conheça o
                  <span class="textDecoration text-complementaryColor3"
                    >CashBest,</span
                  >
            ...
            <div
              class="w-1/2 text-white md:pr-4 sm:hidden mt-auto mb-auto"
              @click="showVideo = true"
            >
              <img
                :src="$options.imageConfig.cashBest.phoneVideoMd"
                alt="Video Crédito com Garantia de Imóvel"
      ...
      <div class="md:hidden xl:hidden lg:hidden maxWidth">
        <h1
          class="text-7xl lg:text-5xl text-center pb-8 sm:text-5xl md:text-6xl titleFontBold text-white"
        >
          E o que é <br />Home<span class="textDecoration"> Equity?</span>
        </h1>

        <p class="text-white text-sm text-center pb-6">
          É o Crédito com Garantia de Imóvel, também conhecido como Empréstimo,
          ideal para quem quer as menores taxas de juros do mercado e um longo
          prazo para pagamento. Nessa modalidade, você utiliza sua casa,
          apartamento ou sala comercial como garantia de crédito e desfruta das
        ...
        <div class="border-1 rounded-xl w-full text-white mr-4">
          ...
          <div class="w-full p-6 bg-secondary rounded-b-xl">
            ...
            <div class="w-full flex pt-6 items-center">
              ...
              <h3 class="text-xl w-full">Prazos de até 20 anos</h3>
            </div>
      ...
      <section class="maxWidth sm:hidden flex md:mt-12 mb-26">
        <div class="w-6/12 sm:w-4/12 mt-auto mb-auto">
          <img
            :src="$options.imageConfig.cashBest.photoMan"
            alt="um homem segurando uma xícara de café e um telefone celular"
            title="Home Equity"
            class="w-full h-auto xl:absolute lg:absolute xl:w-116 lg:w-[28rem] xl:bottom-[-34rem] lg:bottom-[-31rem] mb-0rem"
          />
        </div>

        <div class="w-6/12 sm:w-8/12 mt-auto mb-auto xl:mt-12 lg:mt-6">
          <h1
            class="text-7xl lg:text-5xl sm:text-5xl md:text-6xl titleFontBold text-right text-white"
          >
            E o que é <br />Home<span class="textDecoration"> Equity?</span>
          </h1>
          <p
            class="text-white text-xl sm:text-xs md:text-sm text-right w-11/12 mr-0 ml-auto mt-12 sm:mt-6"
          >
            É o Crédito com Garantia de Imóvel, também conhecido como Home
            Equity, ideal para quem quer as menores taxas de juros do mercado e
            um longo prazo para pagamento. Nessa modalidade, você utiliza sua
            casa, apartamento ou sala comercial como garantia de crédito e
            desfruta das melhores condições disponíveis no mercado.
          </p>
      ...
      <section class="maxWidth flex py-24 sm:py-12">
        <div class="w-1/4 sm:w-1/2 text-white mt-auto mb-auto pr-4">
          <h1 class="text-4xl sm:text-2xl md:text-2xl title-font font-bold">
            Apenas vantagens <br />
            para você
          </h1>
          <h2 class="py-6 text-lg sm:text-sm sm:py-2">
            Descubra porque o
            <span class="text-complementaryColor3">CashBest</span>
        ...
        <div class="w-3/4 sm:w-1/2 mt-auto mb-auto">
          <div
            id="sliderPhone"
            class="bg-bglightColor sm:hidden md:hidden rounded-2xl"
          >
            <Splide
              :options="{
                type: 'loop',
            ...
            >
              <SplideSlide
                v-for="slide in $options.imageConfig.cashBest.sliderPhones"
                :key="slide.img"
              >
                <article>
          ...
          <div
            class="bg-bglightColor xl:hidden lg:hidden sm:hidden rounded-2xl"
          >
            <Splide
              :options="{
                type: 'loop',
          ...
          <div
            class="bg-bglightColor xl:hidden lg:hidden md:hidden rounded-2xl"
          >
            <Splide
              :options="{
                type: 'loop',
      ...
      <section class="maxWidth flex pt-32 sm:pt-8 pb-56 md:pb-4 sm:pb-4">
        <div class="w-3/4 md:w-2/3 sm:w-1/2 flex mt-auto mb-auto">
          <div class="w-full xl:hidden lg:hidden md:hidden rounded-2xl">
            ...
            >
              <SplideSlide
                v-for="slide in $options.imageConfig.cashBest.sliderMoney1"
                :key="slide.img"
              >
          ...
          <div class="w-full xl:hidden lg:hidden sm:hidden rounded-2xl mt-10">
            ...
            >
              <SplideSlide
                v-for="slide in $options.imageConfig.cashBest.sliderMoney2"
                :key="slide.img"
              >
                <article class="pt-[2.5rem]">
                  <img
          ...
          <div class="w-1/3 sm:hidden md:hidden rounded-2xl">
            ...
            >
              <SplideSlide
                v-for="slide in $options.imageConfig.cashBest.sliderMoney3"
                :key="slide.img"
              >
                <article class="pt-[2.5rem]">
                  <img
        ...
        <div
          class="w-1/4 md:w-1/3 sm:w-1/2 text-right text-white mt-auto mb-auto pr-4"
        >
          <h1 class="text-4xl md:text-2xl sm:text-2xl titleFontBold">
            Faça o que você quiser com <br />
            <span class="text-complementaryColor3">seu dinheiro</span>
          </h1>
          <h2 class="py-6 xl:text-lg">
            Depois que os recursos forem liberados na sua conta, você pode usar
            do jeito que quiser.
          </h2>
        </div>
      </section>
    ...
    <section
      class="w-full xl:mt-[-10rem] sm:mt-[-8rem] flex justify-center sm:hidden md:hidden"
    >
      <carouselTutorial />
    </section>
    ...
    <section class="maxWidth xl:hidden lg:hidden">
      <h1
        class="titleFontBold text-5xl sm:text-4xl text-primary text-center py-12"
      >
      ...
      <div class="bg-bglight2Color shadow-xl border-1 rounded-xl p-4">
        <div class="flex w-full">
          <div
            class="mt-auto mb-auto text-xl pr-4 text-primary"
            @click="showTutorial(1)"
          >
      ...
      <div class="bg-bglight2Color mt-4 shadow-xl border-1 rounded-xl p-4">
        <div class="flex w-full">
          <div
            class="mt-auto mb-auto text-xl pr-4 text-primary"
            @click="showTutorial(2)"
          >
            <i v-if="!tutorial.show2" class="ti ti-angle-right"></i>
            <i v-if="tutorial.show2" class="ti ti-angle-down"></i>
          </div>
          <h2 class="text-primary text-2xl titleFontBold pr-2">
            <span class="text-complementaryColor1">#2</span> Envie seus
            documentos
          </h2>
        </div>

        <p v-if="tutorial.show2" class="p-4">
          Para uma análise de crédito mais detalhada, envie os documentos
          solicitados. Após o envio, seus documentos serão analisados e será
          enviada uma proposta concreta.
        </p>
      </div>
      ...
      <div class="bg-bglight2Color mt-4 shadow-xl border-1 rounded-xl p-4">
        ...
        <p v-if="tutorial.show3" class="p-4">
          Nesta etapa, o imóvel passará por uma avaliação que irá certificar que
          o mesmo está apto para ser a garantia do processo.
        </p>
      </div>
      ...
      <div class="bg-bglight2Color mt-4 shadow-xl border-1 rounded-xl p-4">
        <div class="flex w-full">
          ...
          <h2 class="text-primary text-2xl titleFontBold pr-2">
            <span class="text-complementaryColor1">#4</span> Liberação do
            recurso
          </h2>
        </div>

        <p v-if="tutorial.show4" class="p-4">
          Depois de passar por todas as etapas e a documentação estiver
          concluída, seu recurso será liberado! Aqui encerramos a operaçãocom
          êxito, sempre entregando a melhor experiência ao cliente!
        </p>
      </div>
    </section>
        ...
        >
          <div class="w-10/12 sm:w-11/12">
            <div class="w-full flex ml-8 sm:ml-0 py-4">
              <h1
                class="w-1/3 sm:w-2/4 mt-auto mb-0 text-3xl sm:text-xl text-primary text-center font-bold"
              >
                Por que ser Best?
              </h1>
              ...
              <div class="w-1/3 sm:w-1/4 mt-auto mb-0 text-center">
                <div
                  class="text-textSecondary text-3xl sm:text-xl mt-auto mb-auto px-4"
                >
                  Bancos
                </div>
              </div>
...
import carouselTutorial from '@/components/homeEquity/carouselTutorial.vue'
