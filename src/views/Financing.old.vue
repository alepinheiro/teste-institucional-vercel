<!-- <template>
  <div class="w-full bg-bglight2Color overflow-x-hidden overflow-y-hidden">
    <div class="text-textPrimary">
          ...
          <section class="w-full flex mt-6 md:mt-4 sm:mt-4">
            ...
            <div class="md:pt-4 sm:py-8 max-w-[600px] w-full">
              <div class="bg-bglight2Color rounded-xl w-full shadow-2xl p-12">
                ...
                <p class="py-4 pb-6">
                  Financie seu imóvel com as melhores condições do mercado. Tudo
                  de forma online, digital, transparente e com o auxílio do
                  nosso time de especialistas!
                </p>
                <div
                  class="flex w-full items-center border-b-1 border-secondary pb-4"
                >
              ...
              <div>
                ...
                <div class="bg-primary p-4 rounded-xl">
                  ...
                  >
                    ...
                    <p class="w-11/12 text-lg text-white">
                      Sem
                      <span class="text-complementaryColor3">Filas.</span> Sem
                      <span class="text-complementaryColor3">gerentes.</span>
                      Sem
                      <span class="text-complementaryColor3">complexidade</span>
                    </p>
                  </div>
                  <h2 class="w-10/12 text-xl text-white pt-2 font-semibold">
                    De quanto você precisa?
                  </h2>
                  <div class="w-full flex items-end justify-between">
                    <div class="w-9/12 pr-1">
      ...
      <section class="maxWidth sm:hidden flex md:mt-12">
        ...
        <div class="w-6/12 sm:w-[0.7] mt-auto mb-auto">
          <h1
            class="text-8xl sm:text-3xl lg:text-7xl md:text-6xl titleFontBold text-right text-primary pt-8"
          >
            A chave para os seus
            <span class="textDecoration">Sonhos</span>
          </h1>
          <p
            class="text-lg sm:text-xs md:text-sm text-right w-11/12 mr-0 ml-auto mt-12 sm:mt-6"
          >
            Aqui realizamos o sonho da casa própria! Com o financiamento
            imobiliário da SejaBest, você pode garantir ótimas taxas, além de
            ter à sua disposição um assessor que vai te auxiliar do início ao
            fim do processo. É um investimento seguro com diversas vantagens a
            curto e a longo prazo. Com condições facilitadas, o FinanBest é
            perfeito para você!
          </p>
          <div class="pt-6 sm:pt-4 text-right pb-12">
            <button class="buttonComplementaryColor1">
              <a
                ...
                :href="$options.information.appRealEstateSimulator + $root.utms"
                style="text-decoration: none"
                aria-label="Clique aqui para simular seu financiamento"
                target="_blank"
              >
      ...
      <section class="maxWidth xl:hidden lg:hidden md:hidden">
        ...
        <p class="w-full text-center py-8">
          Aqui realizamos o sonho da casa própria! Com o financiamento
          imobiliário da SejaBest, você pode garantir ótimas taxas, além de ter
          à sua disposição um assessor que vai te auxiliar do início ao fim do
          processo. É um investimento seguro com diversas vantagens a curto e a
          longo prazo. Com condições facilitadas, o FinanBest é perfeito para
          você!
        </p>
        <div
          class="border-1 gradienteSBDark rounded-xl w-full text-white flex flex-col self-center"
        >
          <div
          ...
          <div class="w-full p-6 rounded-b-xl">
            ...
            <div class="w-full flex pt-8 items-center">
              ...
              <h3 class="text-xl w-full">Pague em até 420 meses</h3>
            </div>
            <div class="w-full flex pt-8 items-center">
              <div class="pr-6">
                <img
              ...
              <h3 class="text-xl w-full">Os melhores bancos do mercado</h3>
            </div>
    ...
    <section class="w-full mt-8 flex justify-center sm:hidden md:hidden">
    ...
    <section class="w-full pb-16 mb-12 pt-16 sm:pt-0">
      <div class="maxWidth md:w-full flex sm:h-full mr-auto ml-auto sm:ml-0S">
        <div
          class="mt-auto mb-auto w-full bg-bglight2Color shadow-xl border-1 rounded-2xl flex-wrap flex justify-center p-6"
        >
          <div class="w-full flex py-4">
            <h1
              class="w-1/3 sm:w-2/4 text-3xl sm:text-xl mt-auto mb-0 text-primary text-center m:leading-5 font-bold"
            >
              Por que ser Best?
            </h1>
            ...
            <div class="w-1/3 sm:w-1/4 mt-auto mb-0 text-center">
              <div
                class="text-textSecondary text-3xl sm:text-2xl mt-auto mb-auto px-4"
              >
                Bancos
              </div>
            </div>
          ...
          <div class="w-full flex border-b py-3 ml-8 sm:ml-0">
            <h2
              class="w-1/3 sm:w-2/4 mt-auto mb-auto text-center text-textSecondary text-xl sm:text-lg"
            >
