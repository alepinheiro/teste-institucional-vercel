  ...
  <div class="w-full bg-bglight2Color overflow-x-hidden overflow-y-hidden">
    <div class="text-textPrimary gradienteSBLight">
            ...
            <div class="md:pt-4 sm:py-8 max-w-[600px] w-full">
              <div class="bg-primary rounded-xl w-full shadow-2xl mt-12 p-12">
                ...
                <div class=" pt-0 text-white pb-6">
                  As menores taxas do mercado, a partir de <span class="font-semibold">0,88% a.m + IPCA ou fixa 1,49%
                    a.m.</span>
                  Pegando até <span class="font-semibold">60% do valor</span> do seu imóvel como capital para usar como
        ...
        <div class="border-1  rounded-xl w-full text-white mr-4">
          ...
          <div class="w-full p-6 bg-secondary rounded-b-xl">
            ...
            <div class="buttonComplementaryColor1 mt-6 text-center">
              <a
                :href="$options.information.appRealEstateSimulator + ($root as IRootExtension).utms"
                style=" text-decoration: none;" target="_blank">Faça uma simulação</a>
            </div>
          </div>
        </div>
      ...
      <div class="maxWidth sm:hidden flex md:mt-12 mb-26">
        <div class="w-6/12 sm:w-4/12 mt-auto mb-auto">
          ...
          <img
            :src="$options.imageConfig.cashBest.photoMan" alt="Home Equity" class="w-full h-auto xl:absolute lg:absolute
    ...
    <div class="maxWidth xl:hidden lg:hidden">
      ...
      <div class="bg-bglight2Color mt-4 shadow-xl border-1 rounded-xl p-4">
        ...
        <div v-if="tutorial.show2" class="p-4">
      ...
      <div class="bg-bglight2Color mt-4 shadow-xl border-1 rounded-xl p-4">
        ...
        <div v-if="tutorial.show3" class="p-4">
      ...
      <div class="bg-bglight2Color mt-4 shadow-xl border-1 rounded-xl p-4">
        ...
        <div v-if="tutorial.show4" class="p-4">
        ...
        <div
          ...
          <div class="w-10/12 sm:w-11/12">
            <div class="w-full flex ml-8 sm:ml-0 py-4 ">
              <div class="w-1/3 sm:w-2/4 mt-auto mb-0 text-3xl sm:text-xl text-primary text-center font-bold">Por que ser
                Best?</div>
