    ...
    <div class="text-textPrimary ">
              ...
              <div class="text-white w-full  ">
                ...
                <div class="">
                  <button class="buttonComplementaryColor1 sm:p-2 md:p-2">
                    <a
                      class="sm:text-sm text-2xl" :href="$options.information.apppartnerRegistration"
                      style=" text-decoration: none;" target="_blank">Quero ser parceiro</a> </button>
                </div>
      ...
      <div class="bg-bglightColor xl:hidden lg:hidden w-full">
        <div class="maxWidth  ">
          ...
          <div class="w-full gradienteSBLight2 mt-4 rounded-2xl text-white ">
            <img
              :src="$options.imageConfig.partner.businessman" alt="BestHub"
            ...
            <div class=" w-full rounded-t-xl">
              <div class="text-white w-full p-4 sm:text-center md:flex md:flex-col md:items-center ">
                <div class="text-5xl titleFontBold  ">
      ...
      <div class="maxWidth">
        <div class="w-full flex flex-wrap pt-8 sm:pt-16 xl:py-32 xl:pb-20 lg:py-32 md:py-24">
          <div class="w-1/2 mt-auto mb-auto sm:w-full md:w-full md:hidden sm:hidden">
            ...
            alt="Parceiro Best" class="sm:w-full md:w-11/12 w-9/12 h-auto " />
          </div>
      ...
      <div class="maxWidth flex flex-wrap pt-8 sm:pt-16 xl:py-32 lg:py-32 md:py-24">
        <div class="w-1/2 md:w-7/12 mt-auto mb-auto sm:w-full">
          <img
            :src="$options.imageConfig.partner.mockupTablet" alt="BestHub"
        ...
        <div class="w-1/2 md:w-5/12 sm:w-full text-right sm:text-left mt-auto mb-auto text-white">
          ...
          <div class="pt-6 sm:text-base text-xl md:text-base sm:text-center">
            Uma plataforma multibanco e 100% digital. As melhores opções do mercado na palma da sua mão.
          </div>
          <div class="py-6 sm:pt-4 sm:text-base  text-xl md:text-base sm:text-center ">
          ...
          <div class=" sm:text-center">
            <button class="buttonComplementaryColor1  ">
              <a
                ...
                :href="$options.information.apppartnerRegistration" style=" text-decoration: none;" target="_blank">Quero
                ser parceiro</a> </button>
          </div>
        </div>
      </div>
        ...
        <div class="maxWidth    mr-auto ml-auto">
          ...
          <div class="w-full pt-16 sm:pt-8 md:pt-8 flex flex-wrap justify-center">
            <div class="w-1/4 md:w-1/3 sm:w-1/2 pb-12 sm:pb-4 md:pb-8 flex justify-center"><img
                :src="$options.imageConfig.logoPartners.gray.cashme" alt="Cashme" class="w-44 sm:w-36 md:w-36 h-auto " />
            </div>
            <div class="w-1/4 md:w-1/3 sm:w-1/2 pb-12 sm:pb-4 md:pb-8 flex justify-center"><img
                :src="$options.imageConfig.logoPartners.gray.inter" alt="Inter" class="w-44 sm:w-32 md:w-36 h-auto " />
            </div>
            <div class="w-1/4 md:w-1/3 sm:w-1/2 pb-12 sm:pb-4 md:pb-8 flex justify-center"><img
                :src="$options.imageConfig.logoPartners.gray.rodobens" alt="Rodobens"
                class="w-44 sm:w-36 md:w-36 h-auto " /></div>
            <div class="w-1/4 md:w-1/3 sm:w-1/2 pb-12 sm:pb-4 md:pb-8 flex justify-center"><img
                :src="$options.imageConfig.logoPartners.gray.piratini" alt="Piratini"
                class="w-44 sm:w-36 md:w-36 h-auto " /></div>
            <div class="w-1/4 md:w-1/3 sm:w-1/2 pb-12 sm:pb-4 md:pb-8 flex justify-center"><img
                :src="$options.imageConfig.logoPartners.gray.santander" alt="Santander"
                class="w-44 sm:w-36 md:w-36 h-auto " /></div>
            <div class="w-1/4 md:w-1/3 sm:w-1/2 pb-12 sm:pb-4 md:pb-8 flex justify-center"><img
                :src="$options.imageConfig.logoPartners.gray.daycoval" alt="Daycoval"
                class="w-44 sm:w-36 md:w-36 h-auto " /></div>
            <div class="w-1/4 md:w-1/3 sm:w-1/2 pb-12 sm:pb-4 md:pb-8 flex justify-center"><img
                :src="$options.imageConfig.logoPartners.gray.pontte" alt="Pontte" class="w-44 sm:w-36 md:w-36 h-auto " />
            </div>
            <div class="w-1/4 md:w-1/3 sm:w-1/2 pb-12 sm:pb-4 md:pb-8 flex justify-center"><img
                :src="$options.imageConfig.logoPartners.gray.creditas" alt="Creditas"
                class="w-44 sm:w-36 md:w-36 h-auto " /></div>
            <div class="w-1/4 md:w-1/3 sm:w-1/2 pb-12 sm:pb-4 md:pb-8 flex justify-center"><img
                :src="$options.imageConfig.logoPartners.gray.itau" alt="Itaú" class="w-44 sm:w-32 md:w-36 h-auto " />
            </div>
            <div class="w-1/4 md:w-1/3 sm:w-1/2 pb-12 sm:pb-4 md:pb-8 flex justify-center"><img
                :src="$options.imageConfig.logoPartners.gray.libra" alt="Libra" class="w-44 sm:w-32 md:w-36 h-auto " />
            </div>
            <div class="w-1/4 md:w-1/3 sm:w-1/2 pb-12 sm:pb-4 md:pb-8 flex justify-center"><img
                :src="$options.imageConfig.logoPartners.gray.wimo" alt="Wimo" class="w-44 sm:w-32 md:w-36 h-auto " />
            </div>
            <div class="w-1/4 md:w-1/3 sm:w-1/2 pb-12 sm:pb-4 md:pb-8 flex justify-center"><img
                :src="$options.imageConfig.logoPartners.gray.bari" alt="Bari" class="w-44 sm:w-32 md:w-36 h-auto " />
            </div>
          </div>
      ...
      <div class="w-full maxWidth xl:py-32 lg:py-32 py-12 xl:pb-8">
        <div class="w-full flex flex-wrap justify-center ">
          <div class="p-4 w-1/2 sm:w-full ">
            <img
              :src="$options.imageConfig.logoBestHub" alt="BestHub"
        ...
        <div class="w-full flex flex-wrap justify-center pt-16 sm:pt-0">
          ...
          <div
            ...
            <div class="bg-bglightColor rounded-xl flex p-4 h-36 md:h-48 sm:h-auto ">
              ...
              <div
                :class="{ 'glichBlue': glitch }" class="w-full pl-4 md:pl-1 mt-auto mb-auto md:text-sm sm:text-sm"
                @mouseenter="glitch = true" @mouseleave="glitch = false">
                <div class="text-primary text-2xl md:text-xl sm:text-xl">
          ...
          <div
            ...
            <div class="bg-bglightColor rounded-xl flex p-4 h-36 md:h-48 sm:h-auto ">
              <div class="mt-auto mb-auto">
                <img
                  :src="$options.imageConfig.icons.moneyFill" alt="Plataforma multibancos"
                  class="w-auto h-18 sm:h-12 " />
              </div>
      ...
      <div class="w-full  sm:py-4 sm:pl-4 md:pt-4  mr-auto ml-auto flex">
        <div class="w-7/12 lg:w-5/12 xl:pl-[11.3rem] md:pl-4 flex justify-center mt-auto mb-auto ">
          <div
            ...
            <div class="text-5xl sm:text-2xl md:text-4xl font-semibold sm:pt-32">
              Somos <span class="textDecoration">autoridade</span> no assunto
            </div>
            <div class="text-xl sm:text-sm md:text-sm pt-4 lg:pt-8">
