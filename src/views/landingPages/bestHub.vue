    ...
    return {
      questions: [
        ...
        },
        {
          ...
          text: 'Uma simulação detalhada dentro do BesHub, traz todos os detalhes da operação que você escolheu, segundo uma taxa base de mercado (Não é a taxa final).',
          isOpen: false,
        },
        {
          id: 5,
