      ...
      <div class="flex flex-col items-center gap-5 md:gap-0 md:max-w-3xl lg:max-w-5xl xl:max-w-7xl mx-auto h-full">
        ...
        <div class="flex flex-col items-center gap-8 sm:py-18 px-5 md:items-start lg:items-start xl:items-start z-10 my-auto ">
          <img
            ...
            alt=""
          />
          <h1 class="text-4xl sm:text-center text-white md:w-5/6 lg:w-4/6 lg:text-left xl:w-1/2">
            Parabéns por adquirir o melhor curso do mercado de
            <b class="text-[#D0FE42]"> Crédito Imobiliário </b>
          </h1>
          <p class="text-xl text-left text-white leading-loose sm:text-center md:w-5/6 lg:w-4/6 xl:w-1/2">
