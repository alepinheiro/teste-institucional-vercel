            ...
            <div class="relative maxWidth  ">
              <div v-if="isVisiblePillars.show1" class="z-40 absolute maxWidth rounded-xl shadow-xl p-4 bg-gray-100  ">
                ...
                <div class="flex justify-center">
                  ...
                  <a :href="$options.information.socialMedia.youtube" style=" text-decoration: none;" target="_blank">
                    <svg
                      class="w-8 h-8 sm:w-6 sm:h-6 mx-2 fill-primary" xmlns="http://www.w3.org/2000/svg"
              ...
              <div
                ...
                class="z-40 absolute maxWidth rounded-xl rigth shadow-xl p-4 bg-gray-100  ">
                <div class="pb-4 text-center text-xl sm:text-md">
...
export default defineComponent({
  ...
  mounted() {
    let fullUrl: string[]  = this.$route.fullPath.split("?")
    if (this.$route.fullPath.includes("?")) {
      (this.$root as IRootExtension).utms = "?" + (fullUrl[1])
    }
  },
  methods: {
    showPillarsSM(item: number) {
