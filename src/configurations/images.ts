...
/**
 * Logos e imagens com a marca da Bext
 */
export const bextImages = {
  ...
  grayLogo: {
    src: '/images/brand/grayLogo.svg',
    alt: 'Bext',
  },
  whiteLogo: {
    src: '/images/brand/whiteLogo.svg',
    alt: 'Bext',
  },
  blueIcon: {
    src: '/images/brand/blueIcon.svg',
    alt: 'Bext',
  },
  blackAndBlueLogo: {
    src: '/images/brand/blackAndBlueLogo.svg',
    alt: 'Bext',
  },
  whiteAndBlueLogo: {
    src: '/images/brand/whiteAndBlueLogo.svg',
    alt: 'Bext',
  },
  loadingBrandChange: {
    src: '/images/brand/MudancaDeMarca.webm',
    alt: 'SejaBest agora é Bext',
  },
  loadingBrandChangeLight: {
    src: '/images/brand/mudancaMarcaBext.mp4',
    alt: 'SejaBest agora é Bext',
  },
};

/**
 * Logos e imagens de parceiros
 */
...
export const aboutUsPage = {
  ...
  pillars: {
    smColor: {
      education: '/images/webp/aboutUs/3Pilares/PilaresEducacaoCorMobile.webp',
      humanized:
    ...
    sm: {
      ...
      technology: '/images/webp/aboutUs/3Pilares/PilaresTecnologiaPBMobie.webp',
    },
    pb: {
...
export const homePage = {
  ...
  businessPartners: {
    phone: {
      src: '/images/mockups/MockupCelularHomeFinalSimuladorMultibancos.png',
...
export const bextCarPage = {
  ...
  imgMulher: {
    src: '/images/BextCar/IMAGEM_MULHER.webp',
    alt: 'Uma mulher está sorrindo enquanto recebe as chaves de um carro',
  },
  imgBextCar: '/images/BextCar/CABELHO_BextCar.webp',
  imgFinanCar: '/images/BextCar/CABELHO_FINANCAR.webp',
};

export const bextPlay = {
  logo: {
    src: '/images/brand/LogotipoBextPlayNegativo.svg',
    alt: 'BextPlay',
  },
  phoneMockup: {
    src: '/images/mockups/mockupBextPlay.png',
    alt: 'BextPlay- Conheça o maior canal de crédito do Brasil no youtube',
  },
};

export const warrenPage = {
  logo: {
